        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('dingdanxinxi','配送') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="peisongdingdanCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已安排配送')">{{ contents.tableBtnFont == 1?'配送':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','配送') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="peisongdingdanCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已安排配送')">{{ contents.tableBtnFont == 1?'配送':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','配送') && contents.tableBtnIcon == 0" type="success" size="mini" @click="peisongdingdanCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已安排配送')">{{ contents.tableBtnFont == 1?'配送':'' }}</el-button>
  ...
  methods: {
    ...
    payHandler(row){
        let params = {
          ...
          subject: row.shangpinmingcheng,
          totalamount: row.zongjine,
        }
        this.$http({
          url: "dingdanxinxi/alipay",
          method: "get",
          params: params
        }).then(({ data }) => {
                if (data && data.code === 0) {
    ...
    chartDialog() {
      ...
      this.$nextTick(()=>{
        ...
        // xcolumn ycolumn goumaishijian zongjine
