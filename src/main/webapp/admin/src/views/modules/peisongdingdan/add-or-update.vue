<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍地址" prop="sushedizhi">
          <el-input v-model="ruleForm.sushedizhi" 
              placeholder="宿舍地址" clearable  :readonly="ro.sushedizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍地址" prop="sushedizhi">
              <el-input v-model="ruleForm.sushedizhi" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="配送员姓名" prop="peisongyuanxingming">
          <el-select :disabled="ro.peisongyuanxingming" @change="peisongyuanxingmingChange" v-model="ruleForm.peisongyuanxingming" placeholder="请选择配送员姓名">
            <el-option
...
export default {
  ...
  computed: {
    zongjine:{
      get: function () {
        return 1*this.ruleForm.shangpinjiage*this.ruleForm.shangpinshuliang
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='sushedizhi'){
            this.ruleForm.sushedizhi = obj[o];
	    this.ro.sushedizhi = true;
            continue;
          }
          if(o=='gengxinshijian'){
      ...
      this.$http({
		...
		if(json.sushedizhi!=''&&json.sushedizhi){
                this.ruleForm.sushedizhi = json.sushedizhi
	    		this.ro.sushedizhi = true;
		}
        } else {
