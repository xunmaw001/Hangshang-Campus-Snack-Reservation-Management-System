  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">宿舍地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.sushedizhi" class="input" type="text" placeholder="宿舍地址">
			   </div>
			 </div> -->
			<el-form-item label="宿舍地址" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.sushedizhi" autocomplete="off" placeholder="宿舍地址"  />
			</el-form-item>
